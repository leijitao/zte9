...
/**
 * VocalplayerInfo entity. @author MyEclipse Persistence Tools
 */

public class VocalplayerInfo implements java.io.Serializable {
	...
	/** default constructor */
	public VocalplayerInfo() {
	}

	/** minimal constructor */
	public VocalplayerInfo(Timestamp modifyDateTime) {
		this.modifyDateTime = modifyDateTime;
	}

	/** full constructor */
	public VocalplayerInfo(String playerName, String playerDesc, String playerLetter, Short orderSeq,
