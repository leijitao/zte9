...
/**
 * TBillMonth entity. @author MyEclipse Persistence Tools
 */

public class TBillMonth implements java.io.Serializable {
	...
	/** minimal constructor */
	public TBillMonth(String orderNo) {
		this.orderNo = orderNo;
	}

	/** full constructor */
	public TBillMonth(String orderNo, String transactionId, String userId, String productId, Integer status,
