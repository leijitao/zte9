  ...
  <body>
    <div>
    	...
    	<div class="tui_1_bingtu_zoushi">
    		...
    		<div class="tui_1_tongji_head">
    			<span style="float: left;">包月收入占比</span>
    ...
    <script type="text/javascript">
    	...
    	function query2(){
    		window.location='SRBTExcelAction.action'; 
    	} 
    	function shijian(){
				var start = $("#state").val();
				var end = $("#end").val();
				        ...
				        //这里的需要Struts.xml的<action/>的name属性一致。
				       	...
				       	success:function(result){ 
				       		if (result) {
			    				...
			    				str+="<td style='font-weight: bold;'>新增订购人数</td>";
