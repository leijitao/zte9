  ...
  <body>
    <div>
    	...
    	<div class="tui_1_tongji">
    		<div class="tui_1_tongji_head"><span id="retui"></span><span>${musicType.typeName}--${zcode}--统计</span></div>
    	...
    	<div class="tui_1_mingxi">
    		...
    		<div class="zongji">
    			<span>总<span id="sp1">0</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    			<span>本月总点击总人数：<span id="sp2">0</span></span>
    		</div>
    	</div>
    </div>
    ...
    <script type="text/javascript">
    	function shijian(){
     	...
     	function query(){
     		window.location='JMTJEJAllExcelAction.action';
    	} 
    	function ass(number){
    		var str="";
			$.ajax({ 
				//这里的需要Struts.xml的<action/>的name属性一致。
				url:"JMTJEJAllAssAction.action",
				//提交类型
				type:"post",
				//返回的数据类型
				async : false, //同步执行
				data : {code:$("#code").val(),mub:number},
				dataType:"json", 
				//成功是调用的方法
				success:function(clickVO){ 
				    if (clickVO) {
				    	str+="<span>点击总次数："+clickVO.clicks+"</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
				       	str+="<span>点击总人数："+clickVO.clickRen+"</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
				       	$(".zongji").html(str);	
				    }
				}
			});
