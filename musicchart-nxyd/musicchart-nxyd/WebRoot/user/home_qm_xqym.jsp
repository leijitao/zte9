  ...
  <body>
    <div>
    	...
    	<div class="tui_1_tongji">
    		<div class="tui_1_tongji_head"><span>曲目详情-<span id="retui"></span>统计-<a href="FindUserCPMusicAllAction?cpId=${cpId}">返回</a></span></div>
    ...
    <script type="text/javascript">
    	...
    	function query(){
    		window.location='QMUserCPXQExcelAction.action'; 
    	...
    	function ass(number){
			...
			$.ajax({ 
				...
				url:"QMXQAssAction.action",
				//提交类型
				type:"post",
				//返回的数据类型
				async : false, //同步执行
				data : {day:number,cpId:$("#cp").val()},
				dataType:"json", 
				//成功是调用的方法
