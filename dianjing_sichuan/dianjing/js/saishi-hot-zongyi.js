    ...
    switch(e.keyCode){
        ...
        case 13:
            ...
            if(fir==true){
                ...
                if(fir_x==0){
                    window.location.href="http://" + ip_local + "/index.html?html="+ html;
                }else if(fir_x==1){
                    window.location.href="http://" + ip_local + "/saishi.html?html="+ html;
                }else if(fir_x==2){
                    window.location.href="http://" + ip_local + "/hotgame.html?html="+ html;
                }else if(fir_x==3){
                    window.location.href="http://" + ip_local + "/zhubo.html?html="+ html;
                }else if(fir_x==4){
                    window.location.href="http://" + ip_local + "/zongyi.html?html="+ html;
                }
                // else if(fir_x==5){
                //     window.location.href="http://" + ip_local + "/search.html?html="+ html;
                // }
                else if(fir_x==5){
                    window.location.href="http://" + ip_local + "/order.html?html="+ html;
                }
            }else if(sec==true){
                ...
                if(playVideo000[con_x].activityType==6){
                    ...
                    // function newURl() {
                    //     bridge.callHandler('newURlBridgeHandler', "http://"+ ip_local +"/ztlist.html?recomId=" + playVideo000[con_x].id, function (response) {
                    ...
                    window.location.href="http://"+ ip_local + "/ztlist.html?recomId="+playVideo000[con_x].id
                }else if(playVideo000[con_x].activityType==4){
                    // playVideo(JSON.stringify(playVideo000[con_x]));
                    var musicName=encodeURIComponent(playVideo000[con_x].musicName);
                    authentication(playVideo000[con_x].serviceId,"s100000707",musicName,jumpPlayVideoPage());

                    function jumpPlayVideoPage() {
                        var list_rows=[playVideo000[con_x]];
        ...
        case 27:
            if(con==true){
                ...
                if(click_goback==false || x.indexOf("html=")==-1){
                    window.location.href="http://" + ip_local + "/index.html?html="+x;
...
function getNav2Video(i,port) {
    console.log( "getNav2Video from"+store.get("from"));
