document.writeln("<img id=\'imgShouYe\' src=\'images/menu/shouye.png\' style=\'position: absolute; top: 40px; left: 225px; display: none;\' />");
document.writeln("<img id=\'imgSaiShi\' src=\'images/menu/saishi.png\' style=\'position: absolute; top: 40px; left: 391px; display: none;\' />");
document.writeln("<img id=\'imgYouXi\' src=\'images/menu/youxi.png\' style=\'position: absolute; top: 40px; left: 557px; display: none; \' />");
document.writeln("<img id=\'imgZhuBo\' src=\'images/menu/zhubo.png\' style=\'position: absolute; top: 40px; left: 723px; display: none;\' />");
document.writeln("<img id=\'imgZongYi\' src=\'images/menu/zongyi.png\' style=\'position: absolute; top: 40px; left: 889px; display: none;\' />");
document.writeln("<img id=\'imgSearch\' src=\'images/menu/search.png\' style=\'position: absolute; top: 58px; left: 1060px; display: none;\' />");
document.writeln("<img id=\'imgUser\' src=\'images/menu/order.png\' style=\'position: absolute; top: 58px; left: 1156px; display: none; \' />");
...
function InitHead(dt) {
    ...
    dt[0][6] = setBtnForSH("javascript:jumpCatetory('order.html')", "imgUser");
}
